...
export function PharmacistDashboard({ profile, pharmacy, stats = {} }) {
  const { totalItems = 0, lowStock = 0, pendingOrders = 0, filledToday = 0 } = stats
  return (
    <div className="space-y-8">
      ...
      {/* Setup Notice - only show if pharmacy not registered */}
      {!pharmacy && (
      ...
      <div className="grid md:grid-cols-4 gap-6">
        ...
        <Card className="border-border">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl text-orange-500">{lowStock}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl">{filledToday}</CardTitle>
          </CardHeader>
          <CardContent>
