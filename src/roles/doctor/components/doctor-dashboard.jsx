...
export function DoctorDashboard({ profile, stats = {} }) {
  const { totalPrescriptions = 0, activePrescriptions = 0, totalPatients = 0 } = stats
  return (
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card className="border-border">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl">{activePrescriptions}</CardTitle>
          </CardHeader>
          <CardContent>
