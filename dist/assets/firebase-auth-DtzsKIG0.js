import{g as h,_ as g,E as Xe,F as Qe,i as qn,a as Gn,b as zn,L as Kn,c as Kt,S as de,q as ee,e as te,d as Y,f as $e,h as Ze,p as jn,u as $n,j as jt,k as $t,l as Bn,m as Yn,n as v,o as Jn,r as Xn,s as Qn,t as Zn,v as Tt,C as wt,w as yt,x as ei}from"./firebase-core-BFWwuBtV.js";import"./vendor-Dd0M7_Ic.js";import"./react-DIDUf3HZ.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ke=new Kn("@firebase/auth");function ii(n,...e){ke.logLevel<=Kt.WARN&&ke.warn(`Auth (${de}): ${n}`,...e)}function we(n,...e){ke.logLevel<=Kt.ERROR&&ke.error(`Auth (${de}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(nt()||zn()||"connection"in navigator)?navigator.onLine:!0}function si(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class he{constructor(e,t){this.shortDelay=e,this.longDelay=t,C(t>e,"Short delay should be less than long delay!"),this.isMobile=qn()||Gn()}get(){return ri()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ao(n,e){const t=h(n);await De(!0,t,e);const{providerUserInfo:i}=await pi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=Tn(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function ot(n,e,t=!1){const i=await b(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function De(n,e,t){await ae(e);const i=Tn(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";u(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function co(n,e){if(g(n.app))return Promise.reject(T(n));const t=I(n),i=await hr(t,{token:e,returnSecureToken:!0}),r=await A._fromIdTokenResponse(t,"signIn",i);return await t._updateCurrentUser(r.user),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lt(n){const e=I(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function uo(n,e,t){const i=I(n),r={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&Le(i,r,t),await H(i,r,"getOobCode",Ji,"EMAIL_PASSWORD_PROVIDER")}async function lo(n,e,t){await In(h(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&lt(n),i})}async function ho(n,e){await $i(h(n),{oobCode:e})}async function pr(n,e){const t=h(n),i=await In(t,{oobCode:e}),r=i.requestType;switch(u(r,t,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":u(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":u(i.mfaInfo,t,"internal-error");default:u(i.email,t,"internal-error")}let s=null;return i.mfaInfo&&(s=ge._fromServerResponse(I(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function po(n,e){const{data:t}=await pr(h(n),e);return t.email}async function fo(n,e,t){if(g(n.app))return Promise.reject(T(n));const i=I(n),o=await H(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",_n,"EMAIL_PASSWORD_PROVIDER").catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&lt(n),c}),a=await A._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function mo(n,e,t){return g(n.app)?Promise.reject(T(n)):at(h(n),G.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&lt(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function go(n,e,t){const i=I(n),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){u(a.handleCodeInApp,i,"argument-error"),a&&Le(i,o,a)}s(r,t),await H(i,r,"getOobCode",Xi,"EMAIL_PASSWORD_PROVIDER")}function Io(n,e){return me.parseLink(e)?.operation==="EMAIL_SIGNIN"}async function _o(n,e,t){if(g(n.app))return Promise.reject(T(n));const i=h(n),r=G.credentialWithLink(e,t||oe());return u(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),at(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eo(n,e){const t=nt()?oe():"http://localhost",i={identifier:e,continueUri:t},{signinMethods:r}=await fr(h(n),i);return r||[]}async function To(n,e){const t=h(n),r={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&Le(t.auth,r,e);const{email:s}=await Yi(t.auth,r);s!==n.email&&await n.reload()}async function wo(n,e,t){const i=h(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&Le(i.auth,s,t);const{email:o}=await Qi(i.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yo(n,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const i=h(n),s={idToken:await i.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},o=await b(i,mr(i.auth,s));i.displayName=o.displayName||null,i.photoURL=o.photoUrl||null;const a=i.providerData.find(({providerId:c})=>c==="password");a&&(a.displayName=i.displayName,a.photoURL=i.photoURL),await i._updateTokensIfNecessary(o)}function vo(n,e){const t=h(n);return g(t.auth.app)?Promise.reject(T(t.auth)):vn(t,e,null)}function Ao(n,e){return vn(h(n),null,e)}async function vn(n,e,t){const{auth:i}=n,s={idToken:await n.getIdToken(),returnSecureToken:!0};e&&(s.email=e),t&&(s.password=t);const o=await b(n,Ki(i,s));await n._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gr(n){if(!n)return null;const{providerId:e}=n,t=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},i=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&n?.idToken){const r=be(n.idToken)?.firebase?.sign_in_provider;if(r){const s=r!=="anonymous"&&r!=="custom"?r:null;return new $(i,s)}}if(!e)return null;switch(e){case"facebook.com":return new Ir(i,t);case"github.com":return new _r(i,t);case"google.com":return new Er(i,t);case"twitter.com":return new Tr(i,t,n.screenName||null);case"custom":case"anonymous":return new $(i,null);default:return new $(i,e,t)}}class ${constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class An extends ${constructor(e,t,i,r){super(e,t,i),this.username=r}}class Ir extends ${constructor(e,t){super(e,"facebook.com",t)}}class _r extends An{constructor(e,t){super(e,"github.com",t,typeof t?.login=="string"?t?.login:null)}}class Er extends ${constructor(e,t){super(e,"google.com",t)}}class Tr extends An{constructor(e,t,i){super(e,"twitter.com",t,i)}}function Ro(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:gr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ko(n,e){return h(n).setPersistence(e)}function Po(n){return mn(n)}async function So(n,e){return I(n).validatePassword(e)}function wr(n,e,t,i){return h(n).onIdTokenChanged(e,t,i)}function yr(n,e,t){return h(n).beforeAuthStateChanged(e,t)}function No(n,e,t,i){return h(n).onAuthStateChanged(e,t,i)}function Co(n){h(n).useDeviceLanguage()}function bo(n,e){return h(n).updateCurrentUser(e)}function Oo(n){return h(n).signOut()}function Do(n,e){return I(n).revokeAccessToken(e)}async function Lo(n){return h(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=new he(2e3,1e4);async function Go(n,e,t){if(g(n.app))return Promise.reject(w(n,"operation-not-supported-in-this-environment"));const i=I(n);J(n,e,L);const r=z(i,t);return new S(i,"signInViaPopup",e,r).executeNotNull()}async function zo(n,e,t){const i=h(n);if(g(i.auth.app))return Promise.reject(w(i.auth,"operation-not-supported-in-this-environment"));J(i.auth,e,L);const r=z(i.auth,t);return new S(i.auth,"reauthViaPopup",e,r,i).executeNotNull()}async function Ko(n,e,t){const i=h(n);J(i.auth,e,L);const r=z(i.auth,t);return new S(i.auth,"linkViaPopup",e,r,i).executeNotNull()}class S extends Dn{constructor(e,t,i,r,s){super(e,t,r,s),this.provider=i,this.authWindow=null,this.pollId=null,S.currentPopupAction&&S.currentPopupAction.cancel(),S.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return u(e,this.auth,"internal-error"),e}async onExecution(){C(this.filter.length===1,"Popup operations only handle one event");const e=Ue();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(t=>{this.reject(t)}),this.resolver._isIframeWebStorageSupported(this.auth,t=>{t||this.reject(w(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){return this.authWindow?.associatedEvent||null}cancel(){this.reject(w(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,S.currentPopupAction=null}pollUserCancellation(){const e=()=>{if(this.authWindow?.window?.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(w(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,es.get())};e()}}S.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jo(n,e,t){return ss(n,e,t)}async function ss(n,e,t){if(g(n.app))return Promise.reject(T(n));const i=I(n);J(n,e,L),await i._initializationPromise;const r=z(i,t);return await gt(r,i),r._openRedirect(i,e,"signInViaRedirect")}function $o(n,e,t){return os(n,e,t)}async function os(n,e,t){const i=h(n);if(J(i.auth,e,L),g(i.auth.app))return Promise.reject(T(i.auth));await i.auth._initializationPromise;const r=z(i.auth,t);await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function Bo(n,e,t){return as(n,e,t)}async function as(n,e,t){const i=h(n);J(i.auth,e,L),await i.auth._initializationPromise;const r=z(i.auth,t);await De(!1,i,e.providerId),await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function Yo(n,e){return await I(n)._initializationPromise,Un(n,e,!1)}async function Un(n,e,t=!1){if(g(n.app))return Promise.reject(T(n));const i=I(n),r=z(i,e),o=await new ns(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Vn(n){const e=Ue(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zs=300,Ks=$t("authIdTokenMaxAge")||zs;let zt=null;const js=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>Ks)return;const r=t?.token;zt!==r&&(zt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Jo(n=Yn()){const e=jt(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Hi(n,{popupRedirectResolver:Fs,persistence:[qr,Nr,Nn]}),i=$t("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(i,location.origin);if(location.origin===s.origin){const o=js(s.toString());yr(t,o,()=>o(t.currentUser)),wr(t,a=>o(a))}}const r=Bn("auth");return r&&qi(t,`http://${r}`),t}function $s(){return document.getElementsByTagName("head")?.[0]??document}Si({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=r=>{const s=w("internal-error");s.customData=r,t(s)},i.type="text/javascript",i.charset="UTF-8",$s().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Gs("Browser");export{to as ActionCodeOperation,me as ActionCodeURL,fe as AuthCredential,io as AuthErrorCodes,ce as EmailAuthCredential,G as EmailAuthProvider,U as FacebookAuthProvider,Xs as FactorId,F as GithubAuthProvider,V as GoogleAuthProvider,O as OAuthCredential,ve as OAuthProvider,eo as OperationType,q as PhoneAuthCredential,B as PhoneAuthProvider,xs as PhoneMultiFactorGenerator,Qs as ProviderId,Fo as RecaptchaVerifier,Ye as SAMLAuthProvider,Zs as SignInMethod,Hs as TotpMultiFactorGenerator,_t as TotpSecret,x as TwitterAuthProvider,ho as applyActionCode,yr as beforeAuthStateChanged,Vo as browserCookiePersistence,Nr as browserLocalPersistence,Fs as browserPopupRedirectResolver,Nn as browserSessionPersistence,pr as checkActionCode,lo as confirmPasswordReset,qi as connectAuthEmulator,fo as createUserWithEmailAndPassword,no as debugErrorMap,Lo as deleteUser,Eo as fetchSignInMethodsForEmail,Ro as getAdditionalUserInfo,Jo as getAuth,ro as getIdToken,fi as getIdTokenResult,Mo as getMultiFactorResolver,Yo as getRedirectResult,St as inMemoryPersistence,qr as indexedDBLocalPersistence,Hi as initializeAuth,Po as initializeRecaptchaConfig,Io as isSignInWithEmailLink,lr as linkWithCredential,Ho as linkWithPhoneNumber,Ko as linkWithPopup,Bo as linkWithRedirect,Uo as multiFactor,No as onAuthStateChanged,wr as onIdTokenChanged,so as parseActionCodeURL,ni as prodErrorMap,dr as reauthenticateWithCredential,Wo as reauthenticateWithPhoneNumber,zo as reauthenticateWithPopup,$o as reauthenticateWithRedirect,Ii as reload,Do as revokeAccessToken,To as sendEmailVerification,uo as sendPasswordResetEmail,go as sendSignInLinkToEmail,ko as setPersistence,oo as signInAnonymously,at as signInWithCredential,co as signInWithCustomToken,mo as signInWithEmailAndPassword,_o as signInWithEmailLink,xo as signInWithPhoneNumber,Go as signInWithPopup,jo as signInWithRedirect,Oo as signOut,ao as unlink,bo as updateCurrentUser,vo as updateEmail,Ao as updatePassword,qo as updatePhoneNumber,yo as updateProfile,Co as useDeviceLanguage,So as validatePassword,wo as verifyBeforeUpdateEmail,po as verifyPasswordResetCode};
